...
const en: Dict = {
  ...
  'auth.back': '← Back',
  'auth.emailSub': 'Enter your email to sign in or create an account.',
  'auth.profileTitle': 'Create your account',
  'auth.profileSub': 'Tell us a bit about you.',
  'auth.firstName': 'First name',
  'auth.lastName': 'Last name',
  'auth.username': 'Username',
  'auth.useCase': 'What will you use PickGen for?',
  'auth.useCasePlaceholder': 'Select…',
  'auth.createAccount': 'Create account',
  'auth.heroTitle': 'Turn words into images',
  'auth.feat1': 'Describe it in any language — we translate & enhance it',
  'auth.feat2': 'Photo, anime, 3D, watercolor, pixel, logo styles',
  'auth.feat3': 'Pay by card — credit packs from $9.99',
  'usecase.marketing': 'Marketing & social',
  'usecase.design': 'Design & branding',
  'usecase.art': 'Art & hobby',
  'usecase.content': 'Content creation',
  'usecase.business': 'Business & work',
  'usecase.other': 'Other',
  ...
  'gen.examplesTitle': 'Examples made with PickGen',
...
const ru: Dict = {
  ...
  'auth.back': '← Назад',
  'auth.emailSub': 'Введите email, чтобы войти или создать аккаунт.',
  'auth.profileTitle': 'Создать аккаунт',
  'auth.profileSub': 'Немного о себе.',
  'auth.firstName': 'Имя',
  'auth.lastName': 'Фамилия',
  'auth.username': 'Никнейм',
  'auth.useCase': 'Для чего будете использовать PickGen?',
  'auth.useCasePlaceholder': 'Выберите…',
  'auth.createAccount': 'Создать аккаунт',
  'auth.heroTitle': 'Превращай слова в изображения',
  'auth.feat1': 'Описывай на любом языке — мы переведём и улучшим',
  'auth.feat2': 'Стили: фото, аниме, 3D, акварель, пиксель, логотип',
  'auth.feat3': 'Оплата картой — пакеты от $9.99',
  'usecase.marketing': 'Маркетинг и соцсети',
  'usecase.design': 'Дизайн и брендинг',
  'usecase.art': 'Арт и хобби',
  'usecase.content': 'Контент',
  'usecase.business': 'Бизнес и работа',
  ...
  'gen.examplesTitle': 'Примеры, созданные в PickGen',
